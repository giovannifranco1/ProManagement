  ...
  <main class="bg-gray-800 h-screen overflow-hidden relative">
    <div class="flex items-start justify-between">
      <div class="h-screen hidden lg:block shadow-lg relative w-80">
        <div class="h-fubg-gray-700">
          <div class="flex items-center justify-start pt-6 ml-8">
            <p class="font-bold text-gray-700 text-xl">Plannifer</p>
          </div>
          <nav class="mt-6">
            <div>
              <a
              ...
              >
                ...
                <span class="mx-2 text-sm font-normal sm:text-red-600">
                  Home
                </span>
              </a>
              <a
      ...
      <div class="flex flex-col w-full md:space-y-4">
        ...
        <div class="overflow-auto h-screen pb-24 px-4 md:px-6">
          <h1 class="text-4xl font-semibold text-white sm:text-red-800">
          ...
          >
            <div class="w-full md:w-6/12">
              <div
                class="shadow-lg w-full bg-gray-700 relative overflow-hidden"
              >
            ...
            <div class="flex items-center w-full md:w-1/2 space-x-4">
              ...
              <div class="w-1/2">
                <div class="shadow-lg px-4 py-6 w-full bg-gray-700 relative">
                  <p class="text-2xl text-white font-bold">$93.76</p>
          ...
          >
            <div class="w-full">
              <div class="shadow-lg px-4 py-6 w-full bg-gray-700 relative">
                ...
                <div class="flex items-end space-x-2 my-6">
                  <p class="text-5xl text-white font-bold">12</p>
                  <span
                    class="text-green-500 text-xl font-bold flex items-center"
                  >
                    <svg
                      width="20"
                      fill="currentColor"
            ...
            <div class="w-full">
              <div class="shadow-lg px-4 py-6 w-full bg-gray-700 relative">
                ...
                <div class="flex items-end space-x-2 my-6">
                  <p class="text-5xl text-white font-bold">23</p>
                  <span
                    class="text-green-500 text-xl font-bold flex items-center"
                  >
                    <svg
            ...
            <div class="w-full">
              <div class="shadow-lg px-4 py-6 w-full bg-gray-700 relative">
                ...
                <div class="flex items-end space-x-2 my-6">
                  <p class="text-5xl text-white font-bold">12</p>
                  <span
                    class="text-red-500 text-xl font-bold flex items-center"
                  >
                    <svg
                      width="20"
                      fill="currentColor"
            ...
            <div class="w-full">
              <div class="shadow-lg px-4 py-6 w-full bg-gray-700 relative">
                ...
                <div class="flex items-end space-x-2 my-6">
                  <p class="text-5xl text-white font-bold">16</p>
                  <span
                    class="text-red-500 text-xl font-bold flex items-center"
                  >
                    <svg
            ...
            <div class="w-full">
              <div class="shadow-lg px-4 py-6 w-full bg-gray-700 relative">
                ...
                <div class="flex items-end space-x-2 my-6">
                  <p class="text-5xl text-white font-bold">9</p>
                  <span
                    class="text-green-500 text-xl font-bold flex items-center"
                  >
                    <svg
            ...
            <div class="w-full">
              <div class="shadow-lg px-4 py-6 w-full bg-gray-700 relative">
                ...
                <div class="flex items-end space-x-2 my-6">
                  <p class="text-5xl text-white font-bold">15</p>
                  <span
                    class="text-green-500 text-xl font-bold flex items-center"
                  >
                    <svg
